...
public class Data {
    ...
    private static SaveListToFile<NationalID> saveApprovedNationalIdToList = new SaveListToFile<>("files/approvedNationalId.txt");
    private static SaveListToFile<NationalIDApprovingStatus> saveNonApprovedNationalIdToList = new SaveListToFile<>("files/nonApprovedNationalId.txt");

    private static SaveListToFile<Passport> saveApprovedPassport = new SaveListToFile<>("files/approvedPassport.txt");
    private static SaveListToFile<PassportApprovingStatus> saveNonApprovedPassport = new SaveListToFile<>("files/nonApprovedPassport.txt");
